...
class _Settings extends State<Settings> {
  ...
  ListView _formItems() {
    return ListView(
      children: [
        FormItem(text: "ifmieles@espol.edu.ec",label: "Email", hintText: "Ingrese su email",),
        FormItem(text: "Ivan Mieles",hintText: "Nombre", label: "Ingrese su nombre",),
        FormItem(text: "0993299634",label: "Celular", hintText: "Ingrese su celular",),
